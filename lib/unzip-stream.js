...
var SIG_LOCAL_FILE_HEADER  = 0x04034b50;
var SIG_DATA_DESCRIPTOR    = 0x08074b50;
var SIG_CDIR_RECORD        = 0x02014b50;
var SIG_CDIR64_RECORD_END  = 0x06064b50;
var SIG_CDIR64_LOCATOR_END = 0x07064b50;
var SIG_CDIR_RECORD_END    = 0x06054b50;
...
UnzipStream.prototype.processDataChunk = function (chunk) {
    ...
    switch (this.state) {
        ...
        case states.LOCAL_FILE_HEADER_SUFFIX:
            ...
            if (this.options.debug) {
                var debugObj = Object.assign({}, this.parsedEntity, {
                    path: entry.path,
...
UnzipStream.prototype._prepareOutStream = function (vars, entry) {
    ...
    entry.path = entry.path.replace(/(^|[/\\]+)[.][.]+(?=[/\\]+|$)/g, "$1.");
